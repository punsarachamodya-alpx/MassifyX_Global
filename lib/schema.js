...
const sections = [
...

  {
    ...
    fields: [
      ...
      { path: 'showcase.eyebrow', label: 'Showcase eyebrow', type: 'text' },
      { path: 'showcase.headline', label: 'Showcase headline', type: 'text' },
      {
        path: 'showcase.image',
        label: 'Showcase image (full-bleed, slow zoom)',
        type: 'image'
      },
      {
        path: 'valueProps',
      ...
      {
        path: 'process.image',
        label: 'Process supporting image (optional)',
        type: 'image'
      },
      {
        path: 'process.steps',
