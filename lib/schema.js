...
//
// Field types: text | textarea | list | paras | select | boolean | image | repeater
...
const closingFields = [
  ...
  { path: 'closing.cta.href', label: 'Closing button link', type: 'text' }
];
...
const sections = [
    ...
    fields: [
      {
        ...
        fields: [
          ...
          { path: 'href', label: 'Link', type: 'text' }
        ]
      },
      {
        path: 'legal',
      ...
      { path: 'ctaHref', label: 'Button link', type: 'text' }
    ]
  },

  {
    ...
    fields: [
      ...
      { path: 'baseUrl', label: 'Canonical base URL', type: 'text' }
    ]
  },

  {
    key: 'home',
    label: 'Home',
    blurb: 'The front page: hero, value props, process, services, why, and team.',
    fields: [
      ...metaFields,
      ...heroFields,
      { path: 'hero.primaryCta.label', label: 'Primary button label', type: 'text' },
      { path: 'hero.primaryCta.href', label: 'Primary button link', type: 'text' },
      { path: 'hero.secondaryCta.label', label: 'Secondary button label', type: 'text' },
      { path: 'hero.secondaryCta.href', label: 'Secondary button link', type: 'text' },
      {
...

  {
    ...
    fields: [
      ...
      { path: 'founder.linkedin', label: 'Founder LinkedIn URL', type: 'text' },
      {
...

  {
    key: 'contact',
    label: 'Contact',
    blurb: 'Form copy, the booking panel, and delivery configuration.',
    fields: [
      ...metaFields,
      ...heroFields,
      ...
      {
        path: 'deliveryConfigured',
        label: 'Form delivery is wired up to a real inbox',
        type: 'boolean'
      },
      {
      ...
      { path: 'bookingFallbackTitle', label: 'Booking fallback title', type: 'text' },
      { path: 'bookingFallbackBody', label: 'Booking fallback body', type: 'textarea' },
